...
import com.example.springdataintroexercise.model.entity.*;
...
public class BookServiceImpl implements BookService {
    ...
    public void seedBooks() throws IOException {
        ...
        Files
                ...
                .forEach(row -> {
                    ...
                    Book book = createBookFromIfo(bookInfo);
    ...
    @Override
    public List<String> findAllBAuthorsWithBooksWithReleaseDataBeforeYear(int year) {
        return bookRepository.
    ...
    private Book createBookFromIfo(String[] bookInfo) {
